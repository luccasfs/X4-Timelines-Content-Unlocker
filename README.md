...
Run the .py or the .exe.

Main features
The script or the exe will find your userdata.xml in C:\Users\USERNAME\Documents\Egosoft\X4\SteamID then replace and add the necessary values, leaving anything else untouched. It will also create a backup file.

Requirements
Requires Timelines DLC.
